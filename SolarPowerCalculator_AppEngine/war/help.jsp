	        ...
	        <ul>
	        	<li>System Configuration
	        		<ul>
	        			...
	        			<li>Monthly Usage (KWh) - The monthly consumption of electricity at your residence in KiloWatt hours</li>
	        		</ul>
	        	</li>
	        	<li>System Statistics
	        		<ul>
	        			<li>Panel Output (W) - The Watt output of a single panel in your desired (or existing installation)</li>
	        			<li>Panel Degradation (%)PA - The rate at which the solar panels become degraded per year in a percentage</li>
	        	...
	        	<li>Location
	        		<ul>
	        			...
	        			<li>Daylight Hours - The average daylight hours received at your residence. a number between 1 and 24.</li>
